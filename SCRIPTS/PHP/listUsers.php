...
<div class="navegacao_principal">
    ...
    <div class="lista-usuarios">
        <?php foreach ($usersArray as $user):
            ...
            $profilePic = str_replace("/xampp/htdocs", "", htmlspecialchars($user['profile_pic']));
            $userId = htmlspecialchars($user['id_participante']);
            $createDate = (new DateTime($user['create_time']))->format('d/m/Y H:i:s');
        ?>
            <div class="user">
                <div class="user-info">
                    <div class="container-user">
                        ...
                        <div class="user-info">
                            ...
                            <div class="dados-user">
                                <div class="username"> Username: <div class="user-name"><?= $username ?></div> </div>
                                <div class="email"> Email: <div class="user-email"><?= $email ?></div> </div>
                                <div class="create-time"> Creation time: <div class="user-creation-time"><?= $createDate ?></div> </div>
                            </div>
                        </div>
                        <div class="btn-show-post">
                            <div class="show-user-posts">
                                <button class="show-perfil" type="submit" data-id="<?= $userId ?>"
